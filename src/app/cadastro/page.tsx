  ...
  return (
    <Container className="py-14">
      <div className="mx-auto max-w-lg rounded-[32px] border border-white/80 bg-white/90 p-8 shadow-sm">
        ...
        <p className="mt-3 text-slate-600">Crie sua conta para comprar cotas, acompanhar resultados e manter seus comprovantes e movimentações sempre organizados.</p>
