...
export function ReferralLinkCard({ inviteCode }: ReferralLinkCardProps) {
  ...
  return (
    <div className="max-w-full overflow-hidden rounded-[28px] border border-lime-200/70 bg-[radial-gradient(circle_at_top_left,_rgba(187,247,110,0.2),_transparent_30%),linear-gradient(135deg,_#240046_0%,_#40106f_52%,_#22003c_100%)] p-5 text-white shadow-[0_18px_50px_rgba(77,19,148,0.18)]">
      ...
      <div className="mt-5 flex flex-col gap-3 rounded-[24px] border border-white/12 bg-white/10 p-4 backdrop-blur-sm sm:flex-row sm:items-center">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1 break-all text-sm font-medium text-white/95">{inviteLink}</p>
        </div>
        <button
          type="button"
          onClick={handleCopy}
